...
<c:url var="update" value="/update"></c:url>
			...
			<section class="content">
				...
				-->
						...
						<div class="navbar-collapse collapse" id="navbarCollapse">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="#" onclick="location.reload();">Edit</a></li>
				...
				<div class="box box-primary">
					...
					<div class="box-body "
						...
						<form:form action="${update}" modelAttribute="College"
							...
							<div style="margin-bottom: 10px; width: 200px;"
								...
								<form:input path="serialNo" placeholder="66751"
									class="form-control" />
								<!-- Hidden Calculation for some items -->
								<form:hidden path="id" />
								<form:hidden path="grade" />


								<form:hidden path="subject_I_GL" />
								<form:hidden path="subject_II_GL" />
								<form:hidden path="subject_III_GL" />
								<form:hidden path="subject_IV_GL" />
								<form:hidden path="subject_V_GL" />
								<form:hidden path="subject_VI_GL" />
								<form:hidden path="subject_VII_GL" />
								<form:hidden path="subject_VIII_GL" />
								<form:hidden path="subject_IX_GL" />
								<form:hidden path="subject_X_GL" />

								<form:hidden path="subject_I_GP" />
								<form:hidden path="subject_II_GP" />
								<form:hidden path="subject_III_GP" />
								<form:hidden path="subject_IV_GP" />
								<form:hidden path="subject_V_GP" />
								<form:hidden path="subject_VI_GP" />
								<form:hidden path="subject_VII_GP" />
								<form:hidden path="subject_VIII_GP" />
								<form:hidden path="subject_IX_GP" />
								<form:hidden path="subject_X_GP" />
